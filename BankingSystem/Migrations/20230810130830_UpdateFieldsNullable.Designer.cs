...
namespace Banking.API.Migrations
{
    ...
    [Migration("20230810130830_UpdateFieldsNullable")]
    partial class UpdateFieldsNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Banking.Domain.Mappings.ProductChannelMapping", b =>
                {
                    ...
                    b.Property<int>("ProductChannelID")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductChannelMappings");
                });

            modelBuilder.Entity("Banking.Domain.Mappings.ProductSegmentMapping", b =>
                {
                    b.Property<int>("ProductID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProductID", "SegmentID");

                    b.HasIndex("SegmentID");

                    b.ToTable("ProductSegmentMappings");
                });

            modelBuilder.Entity("Banking.Domain.Mappings.UserSegmentMapping", b =>
                {
                    b.Property<int>("UserSegmentMappingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserSegmentMappingID"));
                    ...
                    b.HasKey("UserSegmentMappingID");

                    b.HasIndex("SegmentID");

                    b.HasIndex("UserID");

                    b.ToTable("UserSegmentMappings");
                });
            ...
            modelBuilder.Entity("Banking.Domain.Models.LoanApplication", b =>
                {
                    ...
                    b.HasKey("LoanApplicationID", "UserID");
            ...
            modelBuilder.Entity("Banking.Domain.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Banking.Domain.Models.ProductChannel", b =>
                {
                    b.Property<int>("ProductChannelID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProductChannelID"));

                    b.Property<string>("ProductChannelDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ProductChannelMappingId")
                        .HasColumnType("int");

                    b.Property<string>("ProductChannelName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ProductChannelID");
            ...
            modelBuilder.Entity("Banking.Domain.Models.Segment", b =>
                {
                    b.Property<int>("SegmentID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Banking.Domain.Mappings.ProductChannelMapping", b =>
                {
                    b.HasOne("Banking.Domain.Models.ProductChannel", "Channel")
                        .WithMany()
                        .HasForeignKey("ChannelID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Banking.Domain.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Banking.Domain.Mappings.ProductSegmentMapping", b =>
                {
                    ...
                    b.HasOne("Banking.Domain.Models.Segment", "Segment")
                        .WithMany()
